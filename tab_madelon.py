...
# Load result csv
df_ersvm = pd.read_csv("results/madelon/ersvm.csv")
df_var = pd.read_csv("results/madelon/var.csv")
df_enusvm = pd.read_csv("results/madelon/enusvm.csv")
df_ramp = pd.read_csv("results/madelon/ramp.csv")
