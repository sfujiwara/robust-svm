...
# Load result csv
df_ersvm = pd.read_csv("results/mnist/ersvm_labelflip.csv")
df_var = pd.read_csv("results/mnist/var_labelflip.csv")
df_enusvm = pd.read_csv("results/mnist/enusvm_labelflip.csv")
df_ramp = pd.read_csv("results/mnist/ramp_labelflip.csv")
