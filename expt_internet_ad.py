...
# Logging
logging.basicConfig(
    filename="logs/expt_internet_ad.log",
    level=logging.DEBUG,
    filemode="w",
...
# Save as csv
df_ersvm.to_csv("results/internet_ad/ersvm.csv", index=False)
df_enusvm.to_csv("results/internet_ad/enusvm.csv", index=False)
df_var.to_csv("results/internet_ad/var.csv", index=False)
df_ramp.to_csv("results/internet_ad/ramp.csv", index=False)
